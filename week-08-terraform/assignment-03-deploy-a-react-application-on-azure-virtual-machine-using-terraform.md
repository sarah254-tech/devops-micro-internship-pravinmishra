...
In this assignment, I used Terraform to provision the required Azure infrastructure and automatically deploy the `my-react-app` React application on an Azure Linux virtual machine using a `cloud-init.sh` deployment script passed to the VM through `custom_data`.
...
<![Image6](screenshots/Assignment3_task1c.png)>
...
<![Image8](screenshots/Assignment1_task2-a.png)>
...
<![Image9](screenshots/Assignment3_task3a.png)>
...
<![Image10](screenshots/Assignment3_task3b.png)>
...
<![Image11](screenshots/Assignment3_task3c.png)>

## VM Public IP Address

Record the public IP address displayed by `terraform output`.

**VM Public IP Address:** 20.85.231.73
...
<![Image13](screenshots/Assignment3_task4b.png)>
...
<![Image15](screenshots/Assignment3_task6.png)>
